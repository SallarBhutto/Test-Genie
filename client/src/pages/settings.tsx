...
export default function Settings() {
  ...
  const azureDevOpsMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description:
          "Your Azure DevOps integration settings have been saved successfully.",
      });
    },
    onError: () => {
      toast({
        title: "Error",
        description:
          "Failed to update Azure DevOps settings. Please try again.",
        variant: "destructive",
      });
    },
  });
  ...
  const testConnectionMutation = useMutation({
    mutationFn: async () => {
      const response = await apiRequest(
        "POST",
        "/api/settings/azure-devops/test",
      );
      return response.json();
    },
    onSuccess: (data) => {
  ...
  const handleProjectSync = async () => {
    ...
    try {
      const response = await fetch(
        `/api/azure/sync/project/${selectedProjectId}`,
        {
          method: "POST",
          headers: {
        ...
        <TabsContent value="integrations">
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Configure Azure DevOps integration for automatic bug
                    tracking and bidirectional sync
                  </CardDescription>
                </div>
            ...
            <CardContent>
              <Form {...form}>
                <form
                  onSubmit={form.handleSubmit(handleAzureDevOpsSubmit)}
                  className="space-y-6"
                >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="your-project" {...field} />
                          </FormControl>
                          <FormDescription>
                            The specific project where work items will be
                            created
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Generate a PAT in Azure DevOps with Work Items (Read &
                          Write) permissions
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Optional secret for validating webhook signatures from
                          Azure DevOps
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
                        Set up a webhook to automatically sync changes from
                        Azure DevOps back to QualityBytes when work items are
                        created or updated.
                      </p>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-xs text-blue-600 dark:text-blue-400 mt-2">
                            Replace "your-app-url" with your actual QualityBytes
                            deployment URL
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <ol className="list-decimal list-inside space-y-2 text-sm text-blue-700 dark:text-blue-300">
                            ...
                            <li>
                              Navigate to <strong>Service hooks</strong>
                            </li>
                            <li>
                              Click <strong>+ Create subscription</strong>
                            </li>
                            <li>
                              Select <strong>Web Hooks</strong> as the service
                              type
                            </li>
                            <li>
                              Choose trigger: <strong>Work item created</strong>{" "}
                              or <strong>Work item updated</strong>
                            </li>
                            <li>
                              Filter by work item type: <strong>Bug</strong>{" "}
                              (recommended)
                            </li>
                            ...
                            <li>
                              Add your webhook secret (if configured above) in
                              the <strong>Basic authentication</strong> section
                            </li>
                        ...
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 text-sm text-blue-700 dark:text-blue-300">
                            <li>
                              <strong>Work item created:</strong> Creates a new
                              defect in QualityBytes
                            </li>
                            <li>
                              <strong>Work item updated:</strong> Syncs changes
                              to existing defects
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-3 rounded">
                          <p className="text-sm text-yellow-700 dark:text-yellow-300">
                            <strong>Note:</strong> You may need to create
                            separate webhook subscriptions for "Work item
                            created" and "Work item updated" events, as Azure
                            DevOps typically allows one event type per
                            subscription.
                          </p>
                        </div>
                      </div>
          ...
          {settings?.azureDevOps.enabled && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Synchronize all bugs from Azure DevOps to QualityBytes. This
                  will create new defects for Azure work items that don't exist
                  in QualityBytes and update existing ones.
                </CardDescription>
              </CardHeader>
                        ...
                        {syncResult.stats && (
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                            <div>
                              ...
                              {syncResult.stats.totalAzureWorkItems}
                            </div>
                            <div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                        ...
                        <li>
                          • Uses project Team Names to match Azure Area Paths
                        </li>
                        <li>
                          • Creates new defects for work items not in
                          QualityBytes
                        </li>
                        <li>
                          • Updates existing defects with latest Azure data
                        </li>
                        <li>
                          • Maintains bidirectional sync with webhook
                          integration
                        </li>
                      </ul>
                    </div>
